                ...
                <div class="dashboard-panel-content-item">
					...
					foreach($res->pedidos as $key => $val){
						echo '<div class="row notif_row" id="pedido-' . $val->id . '">';
							...
							echo	$val->id;
							echo '</div>';
							echo '<div class="col-xs-12 hidden-md hidden-lg notif-movil">RAZÓN SOCIAL</div>';
							echo '<div class="col-xs-12 col-md-3 notif_nombre">';
							echo	$val->razon_social;
							echo '</div>';
							// echo '<div class="col-xs-5 col-md-2 notif_id">';
							// echo	$val->email;
							// echo '</div>';
							echo '<div class="col-xs-6 hidden-md hidden-lg notif-movil">FECHA SOLICITUD</div>';
							echo '<div class="col-xs-6 hidden-md hidden-lg notif-movil">FECHA SERVICIO</div>';
							echo '<div class="col-xs-12 hidden-md hidden-lg"></div>';
							echo '<div class="col-xs-6 col-md-2 notif_fecha">';
							echo	$val->fecha_creacion;
							echo '</div>';
							echo '<div class="col-xs-6 col-md-2 notif_fecha">';
							echo	$val->fecha_para_servicio;
							echo '</div>';
							echo '<div class="col-xs-6 hidden-md hidden-lg notif-movil">VALOR</div>';
							echo '<div class="col-xs-6 hidden-md hidden-lg notif-movil">ESTADO</div>';
							echo '<div class="col-xs-12 hidden-md hidden-lg"></div>';
							echo '<div class="col-xs-6 col-md-1 notif_valor">';
							echo	$val->total;
							echo '</div>';
							echo '<div class="col-xs-6 col-md-1 notif_estado">';
							echo	$estados_pedido[$val->estado];
							echo '</div>';
							echo '<div class="col-xs-12 hidden-md hidden-lg"></div>';
							echo '<div class="col-xs-12 hidden-md hidden-lg  notif-movil">acciones</div>';
