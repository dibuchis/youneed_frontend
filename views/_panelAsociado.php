        ...
        <div class="col-md-2 col-xs-12 p-0">
            <div class="profile-side-bar">
                ...
                <nav class="col-xs-12 col-md-12 p-0">
                    ...
                    <div class="profile-menu col-md-12 col-xs-2" id="asoc-prof"><a class="profile-menu-item" href="views/_perfilAsociado.php"><i class="material-icons">person_outline</i> <span class="hidden-xs">Mi Perfil</span></a></div>
                </nav>
            </div>
        </div>
