    ...
    <div class="container" id="form-registro-cliente">
        ...
        <div class="panel panel-primary setup-content panel-default">
	            ...
	            <div class="panel-heading">
	                 ...
	                 <h3 class="panel-title">Estado de Solicitud</h3>
	            ...
	            <div class="panel-body">
	            	...
	            	<div class="row">
                        ...
                        <div class="col-md-12">
							...
							<p>Muy pronto se comunicarán con tigo.</p>

                            <p><a class="btn btn-success" href="https://youneed.com.ec/app/dashboard.php">Volver al perfil</a></p></center>
